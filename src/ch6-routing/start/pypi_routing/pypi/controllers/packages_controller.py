...
@view_config(route_name='package_details', renderer='pypi:templates/packages/details.pt')
@view_config(route_name='package_details/', renderer='pypi:templates/packages/details.pt')
...
@view_config(route_name='release_version', renderer='pypi:templates/packages/release_version.pt')
@view_config(route_name='release_version/', renderer='pypi:templates/packages/release_version.pt')
...
def release_version(request: Request):
    ...
    return {
        "package_name":  "The #{} most popular package".format(num)
    }
